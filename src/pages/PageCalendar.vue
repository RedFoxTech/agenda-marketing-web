    ...
    <b-container fluid>
      <b-row>
        <b-col cols="12" sm="3" lg="2" class="p-3 menuLateral">
          ...
          />
          <router-link to="/">
            <b-icon-arrow-bar-left class="mt-5" />Sair
          </router-link>
        </b-col>
          ...
          <b-row>
            <b-col>
              <b-form-group>
                ...
                <b-form-datepicker id="input-3" v-model="scheduleModal.start._date" class="mb-2"></b-form-datepicker>
              </b-form-group>
            </b-col>
            <b-col>
              <b-form-group>
                <label for="input-4">Fim</label>
                <b-form-datepicker id="input-4" v-model="scheduleModal.end._date" class="mb-2"></b-form-datepicker>
              </b-form-group>
            </b-col>
          </b-row>
          <b-form-group>
