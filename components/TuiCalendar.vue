...
export default {
    ...
    schedules: {
      ...
      validator(value) {
        ...
        value.forEach(schedule => {
          notHave = scheduleNeedProp.some(prop =>
            hasOwnProperty.call(!schedule, prop)
          );
        });
        return !notHave;
      }
  ...
  methods: {
    ...
    createSchedule(res) {
      this.calendarInstance.createSchedules([res]);
    },
